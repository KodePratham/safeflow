...
│     │              │          │                                         │
│     │  Continues   │◀─────────┘                                         │
│     │  dripping    │    (after each claim, continues if funds remain)  │
│     └──────────────┘                                                    │
│                                                                          │
└─────────────────────────────────────────────────────────────────────────┘
```
...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│   1. BRIDGE                2. CREATE               3. STREAM             │
│   ┌─────────┐             ┌─────────┐             ┌─────────┐           │
│   │ Connect │             │ Create  │             │  Funds  │           │
│   │ MetaMask│────────────▶│SafeFlow │────────────▶│  Drip   │           │
│   │  + USDC │             │  Stream │             │Automate │           │
│   └─────────┘             └─────────┘             └─────────┘           │
│       │                        │                       │                │
│       │ • Approve USDC        │ • Set recipient       │ • Per block     │
│       │ • Bridge via          │ • Lock USDCx          │   calculation   │
│       │   xReserve            │ • Set drip rate       │ • Bitcoin-      │
│       │ • Receive USDCx       │ • Choose interval     │   secured       │
│       │   on Stacks           │   (daily/monthly)     │   timing        │
│       │                        │                       │                │
│       ▼                        ▼                       ▼                │
│                                                                          │
│   4. CLAIM                 5. MANAGE              6. COMPLETE           │
│   ┌─────────┐             ┌─────────┐             ┌─────────┐           │
│   │Recipient│             │  Admin  │             │ Stream  │           │
│   │ Claims  │◀────────────│ Control │────────────▶│ Ends    │           │
│   │ Funds   │             │         │             │         │           │
│   └─────────┘             └─────────┘             └─────────┘           │
│       │                        │                       │                │
│       │ • Check claimable     │ • Freeze/Unfreeze    │ • All funds     │
│       │ • Call claim()        │ • Update drip rate   │   claimed       │
│       │ • Receive USDCx       │ • Add funds          │ • Stream        │
│       │                        │ • Cancel stream      │   complete      │
│       │                        │                       │                │
│       ▼                        ▼                       ▼                │
│   ┌─────────────────────────────────────────────────────────┐           │
